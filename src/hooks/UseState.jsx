...
const UseState = () => {
  ...
  return (
    <div className='p-4 '>
        ...
        <button onClick={decrement} className='bg-blue-500 text-white px-4 py-3 rounded-xl hover:bg-blue-700 transition duration-300 cursor-pointer'>decrement</button>
